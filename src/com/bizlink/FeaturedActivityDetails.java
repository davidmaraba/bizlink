...
public class FeaturedActivityDetails extends Activity {
    ...
    // single product url
    private static String url_all_products = "http://10.0.2.2/bizlink/get_featured_details.php";
   ...
   // private static final String url_delete_product = "http://10.0.2.2/AndroidHive/delete_product.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txtPhone=(EditText) findViewById(R.id.invite_phone);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
				...
				String sms ="Product: ".concat(productName).concat(" Price: ").concat(pricing).concat(" Description: ").concat(description)
						.concat("Powered by BizLink http://www.bizlink.com");
				...
				try {
					...
					new AlertDialogManager().showAlertDialog(FeaturedActivityDetails.this,"Referral Sent",sms,true);
				} catch (Exception e) {
	...
	protected void onActivityResult(int reqCode, int resultCode, Intent data) {
		...
		switch(reqCode)
		{
		   case (PICK_CONTACT):
		     ...
		     {
		    	new AlertDialogManager().showAlertDialog(FeaturedActivityDetails.this, "No contact", "Couldn't find", false); 
		     }
		}
	}
    ...
    class GetProductDetails extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(FeaturedActivityDetails.this);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (success == 1) {
                        	...
                        	new AlertDialogManager().showAlertDialog(FeaturedActivityDetails.this,"No details","Can't find the full details, Get back shortly",false);
